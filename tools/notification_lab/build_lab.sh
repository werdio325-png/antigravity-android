...
OUTPUT_APK="$LAB_DIR/AntigravityNotifyLab.apk"

if [ "$1" = "clean" ]; then
    echo "[*] Cleaning Notification Lab build artifacts..."
    rm -rf "$BUILD_DIR"
    echo "[+] Clean complete."
    exit 0
fi
...
echo "========================================="
echo "   Building Antigravity Notify Lab APK   "
echo "========================================="
...
javac -encoding UTF-8 -d "$BUILD_DIR/obj" \
    -cp "$ANDROID_JAR" \
    "$BUILD_DIR/gen/com/antigravity/notify/lab/R.java" \
    "$LAB_DIR/src/com/antigravity/notify/lab/"*.java
...
java -cp "$R8_JAR" com.android.tools.r8.D8 \
    ...
    --lib "$ANDROID_JAR" \
    --min-api 26 \
    "$BUILD_DIR/obj/com/antigravity/notify/lab/"*.class
